...
* (Almost) all letters represent a consonant, carrying an *inherent* vocal: "a"
* These letters/syllables are sorted according to tonality and aspiration (in pronunciation)
...
Note: Optional character *can* form *ligatures* with the character they are combined with.
...
* The graphical representation will depend on building *ligatures* and thus on the font you are using.
...
"Nobody needs such a module!" -- you might say. I agree. But the *one* person
who might need it will be more than happy to have. (Given he/she finds it in the webz).
...
I am in *no way* any expert in Classical Tibetan. I can't even read one sentence.
...
it *your reponsibility* to let me know!
